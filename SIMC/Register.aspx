<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SIMC.Register" %>
                        ...
                        <div class="card-body">
                            <div class="auth-logo">
                                ...
                                <a href="register.aspx">
                                    <img src="assets/images/logo/ATL.png" alt="Logo"></a>
                            </div>
                            ...
                            <section id="multiple-column-form">
                                ...
                                Display="Dynamic" ForeColor="Red" Text="(Email Pattern Only)" SetFocusOnError="true" ValidationGroup="valAdd"
                                ...
                                ValidationExpression="^[a-zA-Z ]*$" EnableClientScript="True" />
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="ddlstatus" runat="server"
                                Display="Dynamic" ForeColor="Red" Text="Isi Data Terlebih Dahulu" SetFocusOnError="true" ValidationGroup="valAdd" EnableClientScript="True">
                            </asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            <asp:DropDownList ID="ddlpdkakhir" CssClass="form-select" runat="server">
                                             ...
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ControlToValidate="ddlpdkakhir" runat="server"
                                Display="Dynamic" ForeColor="Red" Text="Isi Data Terlebih Dahulu" SetFocusOnError="true" ValidationGroup="valAdd" EnableClientScript="True">
                            </asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                ...
                                ValidationExpression="^[a-zA-Z ]*$" EnableClientScript="True" />
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="TxtTambahHP" runat="server"
                                Display="Dynamic" ForeColor="Red" Text="Isi Data Terlebih Dahulu" SetFocusOnError="true" ValidationGroup="valAdd" EnableClientScript="True">
                            </asp:RequiredFieldValidator>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            ...
                                            <asp:RadioButtonList ID="rbJK" runat="server" RepeatDirection="Horizontal" Width="100%">
                                                <asp:ListItem Text="Laki-Laki" Value="Laki-Laki" />
                                                <asp:ListItem Text="Perempuan" Value="Perempuan" />
                                            </asp:RadioButtonList>
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="rbJK" runat="server"
                                Display="Dynamic" ForeColor="Red" Text="Isi Data Terlebih Dahulu" SetFocusOnError="true" ValidationGroup="valAdd" EnableClientScript="True">
                            </asp:RequiredFieldValidator>
                                        </div>
                                    </div>
