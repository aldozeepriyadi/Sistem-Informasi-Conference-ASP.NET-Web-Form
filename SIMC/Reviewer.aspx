<%@ Page Title="" Language="C#" MasterPageFile="~/PageReviewer.Master" AutoEventWireup="true" CodeBehind="Reviewer.aspx.cs" Inherits="SIMC.WebForm10" %>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <asp:Label ID="lblTotalAbstrakYangMasuk" CssClass="text-muted font-semibold" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
