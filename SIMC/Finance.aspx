<%@ Page Title="" Language="C#" MasterPageFile="~/PageFinance.Master" AutoEventWireup="true" CodeBehind="Finance.aspx.cs" Inherits="SIMC.Finance" %>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <asp:Label ID="lblTotalPembayaran" CssClass="font-extrabold mb-0" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <asp:Label ID="lblJumlahPembayaran" CssClass="font-extrabold mb-0" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
