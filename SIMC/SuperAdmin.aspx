<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SuperAdmin.aspx.cs" Inherits="SIMC.WebForm1" %>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <asp:Label ID="lblAdmin" CssClass="font-extrabold mb-0" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <asp:Label ID="lblEventAktif" CssClass="font-extrabold mb-0" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
